...
namespace SuperSocket.JTT.Base.Model
{
    ...
    /// <para>消息包编码时 执行方法为对<see cref="SuperSocket.JTT.Base.Interface.IJTTProtocol.InternalEntitysMappings"/>的Key先使用<see cref="Decode"/>配置编码, 再使用<see cref="Encode"/>配置解码</para>
    /// </remarks>
