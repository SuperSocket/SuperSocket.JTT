...
namespace SuperSocket.JTT1078.MessageBody
{
    ...
    /// </remarks>
    public class UpDownloadMsgBody : IJTTMessageBody
    {
        /// <summary>
        /// 车牌号
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// <para>远程录像下载请求应答消息数据体<see cref="Internal.DownloadStartupReplyBody"/></para>
        /// <para>远程录像下载完成通知消息数据体<see cref="Internal.DownloadEndInformRequestBody"/></para>
        /// <para>远程录像下载控制请求应答消息数据体<see cref="Internal.DownloadControlReplyBody"/></para>
        /// </remarks>
