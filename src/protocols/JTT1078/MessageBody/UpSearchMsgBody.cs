...
namespace SuperSocket.JTT1078.MessageBody
{
    ...
    /// </remarks>
    public class UpSearchMsgBody: IJTTMessageBody
    {
        /// <summary>
        /// 车牌号
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// <para>主动上传音视频资源目录信息消息数据体<see cref="Internal.UploadFilelistRequestBody"/></para>
        /// <para>查询音视频资源目录应答消息数据体<see cref="Internal.SearchFilelistReplyBody"/></para>
        /// </remarks>
