...
namespace SuperSocket.JTT1078.MessageBody
{
    ...
    /// </remarks>
    public class DownPlaybackMsgBody : IJTTMessageBody
    {
        /// <summary>
        /// 车牌号
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// <para>远程录像回放请求消息数据体<see cref="Internal.PlaybackStartupRequestBody"/></para>
        /// <para>远程录像回放控制消息数据体<see cref="Internal.PlaybackControlRequestBody"/></para>
        /// </remarks>
